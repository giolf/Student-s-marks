...
import static myapps.studentgrades.Utility.monthFromIntToString;

/**
 * Created by Gio on 01.12.2014.
 */
public class ModificaVoto extends Fragment {
    /**
     ...
     * number.
     */
    public static ModificaVoto newInstance(int sectionNumber) {
        ModificaVoto fragment = new ModificaVoto();
